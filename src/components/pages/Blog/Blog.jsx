...
const Blog = () => {
  ...
  return (
    <>
      {!user ? (
        <div>
          <h2>Please Log in to View This page Content</h2>
        </div>
      ) : (
        <div className="w-3/4 mx-auto border rounded-xl">
          <div className="collapse rounded-lg my-3">
            ...
            <div className="collapse-content my-2 bg-primary text-primary-content peer-checked:bg-sky-900 peer-checked:text-secondary-content">
              <p>
                <strong>SQL</strong>: Structured Query Language or SQL is a
                standard Daabase language which is used to create, maintain and
                retrieve the data from relational databases like MySQL, Oracle,
                SQL Server, PostGre, etc.
                <strong>noSQL</strong>: originally referring to non SQL or non
                relational is a database that provides a mechanism for storage
                and retrieval of data. This data is modeled in means other than
                the tabular relations used in relational databases. Such
                databases came into existence in the late 1960s, but did not
                obtain the NoSQL moniker until a surge of popularity in the
                early twenty-first century. NoSQL databases are used in
                real-time web applications and big data and their use are
                increasing over time. NoSQL systems are also sometimes called
                Not only SQL to emphasize the fact that they may support
                SQL-like query languages. A NoSQL database includes simplicity
                of design, simpler horizontal scaling to clusters of machines
          ...
          <div className="collapse rounded-lg my-3">
            ...
            <div className="collapse-content my-2 bg-primary text-primary-content peer-checked:bg-sky-900 peer-checked:text-secondary-content">
              <p>
                <strong>JWT</strong>: JWT, or JSON Web Token, is an open
                ...
                token is issued. <br />
                <strong>How it Works</strong>: JWTs differ from other web tokens
                in that they contain a set of claims. Claims are used to
                ...
                permissions the client has been granted. A JWT is a string made
                ...
                Signing and Encryption) header contains the type of token — JWT
                ...
                action they are requesting. <br />
                <br />
                There are no mandatory claims for a JWT, but overlaying
                standards may make claims mandatory. For example, when using JWT
                as bearer access token under OAuth2.0, iss, sub, aud, and exp
                must be present. some are more common than others. <br />
                <br />
                ...
                private key known only to the sender. When the token is used,
                the receiving party verifies that the header and payload match
                the signature.
              </p>
            </div>
          </div>
          <div className="collapse rounded-lg my-3">
            ...
            <div className="collapse-content my-2 bg-emerald-800 text-primary-content peer-checked:bg-sky-900 peer-checked:text-secondary-content">
              <p>
                <strong>NodeJS</strong>: NodeJS is a cross-platform and
                opensource Javascript runtime environment that allows the
                javascript to be run on the server-side. Nodejs allows
                Javascript code to run outside the browser. Nodejs comes with a
                lot of modules and mostly used in web development.
                <strong>JavaScript</strong>: Javascript is a Scripting language.
                It is mostly abbreviated as JS. It can be said that Javascript
                is the updated version of the ECMA script. Javascript is a
                high-level programming language that uses the concept of Oops
